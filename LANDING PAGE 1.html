...
<body>
    <header role="banner">
        <img src="IMATGES LANDING PAGE/LOGO.PNG" alt="Logo ECHO" height="200" width="200">
    </header>
    <nav role="navigation">
    ...
    <div class="container">
        <div class="main-content" role="main">
            <section id="inicio" aria-label="Sección de Inicio">
                ...
                <p>En ECHO buscamos que nustros clientes se sumen a nuestra causa, para conseguir eso, queremos promocionar una visión de la moda sostenible y ética, con prendas de ropa fabricadas a partir de materiales reciclados.</p>
                
            </section>
            <section id="Servicios" aria-label="Sección de Servicios"><a href="#Servicios"></a>
                <h2>Servicios</h2> <img src="IMATGES LANDING PAGE/cart.png" alt="Icono carro de la compra" height="20" width="20">
                <h3>Productos</h3> 
                <p>Disponemos de diferentes prendas de ropa</p>
                <img src="IMATGES LANDING PAGE/PRENDA_1.PNG" alt="Sudadera 1" height="200" width="200">    
                <img src="IMATGES LANDING PAGE/PRENDA_2.PNG" alt="Sudadera 2" height="200" width="200">     
                <img src="IMATGES LANDING PAGE/PRENDA_3.PNG" alt="Sudadera 3" height="200" width="200">     
                ...
                <img src="IMATGES LANDING PAGE/donar.png" alt="Donar ropa" height="100" width="200">
        </div>
        <aside role="complementary">
            <h3>¡ESTAMOS COMPROMETIDOS!</h3>
            <div class="card" style="width: 18rem;">
                <img src="IMATGES LANDING PAGE/RRR.png" class="card-img-top" alt="Reutilizar, Reducir, Reciclar"><br><br>
                <div class="card-body">
    ...
    <footer role="contentinfo">
        ...
        <br>
        Datos de contacto: contacto@echo.com | Teléfono: 636736101 <img src="IMATGES LANDING PAGE/phone-call.png" alt="Icono telefono" height="20" width="20">
    </footer>
</body>
</html>